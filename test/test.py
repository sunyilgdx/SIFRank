...
keyphrases = SIFRank(text, SIF, en_model, elmo_layers_weight=elmo_layers_weight)
keyphrases_ = SIFRank_plus(text, SIF, en_model, elmo_layers_weight=elmo_layers_weight)
print(keyphrases)
print(keyphrases_)